...
execute "s3cmd" do
  command "mkdir /home/ubuntu/doink-unfiltered ; s3cmd sync --recursive s3://doink-unfiltered/target /home/ubuntu/doink-unfiltered/"
  cwd "/home/ubuntu"
  action :run
end

# Fire up the server as a service!
runit_service "deploy-doink-unfiltered"
